...
<div class="main1">
    <div class="wrapper">
        ...
        <div class="container">
            ...
            <div id="slide1"><img style="width:50px; margin-left:185px" src="kooka1.jpeg" alt=""></div>
            <div id="slide2"><img style="width:100px; margin-left:185px" src="kooka2.jpeg" alt=""></div>
            ...
            <div class="navigation">
                ...
                <li>
                    <div class="btn">
                        <a href="#slide1" style="width:20px"><img style="width:20px; margin-left:25px" src="kooka1.jpeg" alt=""></a>
                    </div>
                </li>

                <li>
                    <div class="btn">
                        <a href="#slide2"><img style="width:20px; margin-left:25px" src="kooka2.jpeg" alt=""></a>
                    </div>
                </li>
