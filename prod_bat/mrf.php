...
<div class="main1">
    <div class="wrapper">
        ...
        <div class="container">
            ...
            <div id="slide1"><img style="width:120px;height:260px; margin-left:185px" src="mrf1.jpeg" alt=""></div>
            <div id="slide2"><img style="width:140px; margin-left:175px" src="mrf2.jpeg" alt=""></div>
            ...
            <div class="navigation">
                ...
                <li>
                    <div class="btn">
                        <a href="#slide1" style="width:20px"><img style="width:20px; margin-left:25px" src="mrf1.jpeg" alt=""></a>
                    </div>
                </li>

                <li>
                    <div class="btn">
                        <a href="#slide2"><img style="width:20px; margin-left:25px" src="mrf2.jpeg" alt=""></a>
                    </div>
                </li>

                <!-- <li>
                    <div class="btn">
                        <a href="#slide3"><img src="https://wallpapercave.com/wp/wp2609960.jpg" alt=""></a>
                    </div>
                </li>
