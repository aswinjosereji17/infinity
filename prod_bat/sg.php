...
<div class="main1">
    <div class="wrapper">
        ...
        <div class="container">
            ...
            <div id="slide1"><img style="width:210px; margin-left:130px" src="sg1.jpeg" alt=""></div>
            <div id="slide2"><img style="width:50px; margin-left:185px" src="sg2.jpeg" alt=""></div>
            <div id="slide3"><img style="width:50px; margin-left:185px" src="sg3.jpeg" alt=""></div>
            ...
            <div class="navigation">
                ...
                <li>
                    <div class="btn">
                        <a href="#slide1" style="width:20px"><img style="width:20px; margin-left:25px" src="sg1.jpeg" alt=""></a>
                    </div>
                </li>

                <li>
                    <div class="btn">
                        <a href="#slide2"><img style="width:20px; margin-left:25px" src="sg2.jpeg" alt=""></a>
                    </div>
                </li>
                <li>
                    <div class="btn">
                        <a href="#slide3"><img style="width:20px; margin-left:25px" src="sg3.jpeg" alt=""></a>
                    </div>
                </li>
